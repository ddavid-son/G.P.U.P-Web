...
public class WhatIfDTO {
    CommonEnums.RelationType targetType = CommonEnums.RelationType.DEPENDS_ON;
    String targetName;
    ...
    public WhatIfDTO(CommonEnums.RelationType targetType, String targetName,
    ...
    public CommonEnums.RelationType getTargetType() {
        return targetType;
    }

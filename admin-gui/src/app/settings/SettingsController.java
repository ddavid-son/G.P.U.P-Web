...
public class SettingsController {
    ...
    void onTheme1Clicked(ActionEvent event) {
        ...
        theme1.getScene().getStylesheets().clear();
        theme1.getScene().getStylesheets().add(appController.themeCSSPath);
    }
    ...
    void onTheme2Clicked(ActionEvent event) {
        ...
        appController.setThemeCSSPath(appController.themeCSSPath);
        theme2.getScene().getStylesheets().clear();
        theme2.getScene().getStylesheets().add(appController.themeCSSPath);
    }
    ...
    void onTheme3Clicked(ActionEvent event) {
        ...
        appController.setThemeCSSPath(appController.themeCSSPath);
        theme3.getScene().getStylesheets().clear();
        theme3.getScene().getStylesheets().add(appController.themeCSSPath);
    }

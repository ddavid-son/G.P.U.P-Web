...
import argumentsDTO.CommonEnums.TargetType;
...
public class Target implements Serializable {
    ...
    public argumentsDTO.CommonEnums.TargetState getState() {
        return state;
    }

    public argumentsDTO.CommonEnums.TargetType getType() {
        return type;
    }

    protected void setType(argumentsDTO.CommonEnums.TargetType targetType) {
        this.type = targetType;
    }

    protected void setState(argumentsDTO.CommonEnums.TargetState targetState) {
